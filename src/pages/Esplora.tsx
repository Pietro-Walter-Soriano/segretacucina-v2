...
export default function Esplora() {
  ...
  // Scroll alla sezione richiesta dall'hash (es. /esplora#contatti)
  useEffect(() => {
    if (hash) {
  ...
  return (
    <div className="bg-bianco text-blu-scuro overflow-x-hidden font-sans">
      ...
      {/* ===== INFO ===== */}
      <section id="info" className="relative bg-giallo overflow-hidden py-24">
      ...
      {/* ===== AREE ===== */}
      <section className="relative bg-bianco py-24">
        <Reveal>
